...
$string['coursesettings'] = 'eduTrader - Kurseinstellungen';
$string['coursesettings:description'] = 'Wählen Sie hier welche Artikel verfügbar sein sollen.';
$string['edutrader:addinstance'] = 'Aktiviere eduTrading';
$string['edutrader:myaddinstance'] = 'Aktiviere eduTrading';
$string['FNS'] = 'Funnies';
...
$string['toggle_item_enabled'] = 'Aktiviere {$a->title}';
$string['toggle_item_enabled:description'] = 'Mit dieser Einstellung können Sie systemweit steuern, ob der Artikel <strong>{$a->title}</strong> im block_edutrader sichtbar ist.';
$string['t_days'] = 'Tage';
